...
#define	DECLARE_INLINE_ENUM_FLAG_OPERATORS_IN_CLASS_Z(_enumType) \
	/*ASSERT_AT_COMPILE_TIME_Z(sizeof(_enumType) == sizeof(U32));*/ \
	inline constexpr friend _enumType operator+(_enumType _a, _enumType _b){ return _enumType( ((U32)_a) | ((U32)_b) ); } \
	inline constexpr friend _enumType& operator+=(_enumType& _a, _enumType _b){ _a = _enumType(((U32)_a) | ((U32)_b)); return _a; } \
	inline constexpr friend _enumType operator|(_enumType _a, _enumType _b){ return _enumType( ((U32)_a) | ((U32)_b) ); } \
	inline constexpr friend _enumType& operator|=(_enumType& _a, _enumType _b){ _a = _enumType(((U32)_a) | ((U32)_b)); return _a; } \
	inline constexpr friend _enumType operator&(_enumType _a, _enumType _b){ return _enumType((U32)_a & (U32)_b); } \
	inline constexpr friend _enumType& operator&=(_enumType& _a, _enumType _b){ _a = _enumType(((U32)_a) & ((U32)_b)); return _a; } \
	inline constexpr friend _enumType operator^(_enumType _a, _enumType _b){ return _enumType((U32)_a ^ (U32)_b); } \
	inline constexpr friend _enumType& operator^=(_enumType& _a, _enumType _b){ _a = _enumType(((U32)_a) ^ ((U32)_b)); return _a; } \
	inline constexpr friend _enumType operator~(_enumType _a){ return _enumType( ~((U32)_a) ); }\
	inline constexpr friend _enumType operator++(_enumType &_a) { _a = (_enumType)(((U32)_a)+1); return _a;} \
	inline constexpr friend _enumType operator++(_enumType &_a, int) { _enumType ret=_a; _a=(_enumType)(((U32)_a)+1); return ret; } \
	inline constexpr friend _enumType operator--(_enumType &_a) { _a = (_enumType)(((U32)_a)-1); return _a;} \
	inline constexpr friend _enumType operator--(_enumType &_a, int) { _enumType ret=_a; _a=(_enumType)(((U32)_a)-1); return ret; } \
	inline constexpr friend _enumType operator<<(_enumType _a,int n){ return _enumType( ((U32)_a)<<n ); } \
	inline constexpr friend _enumType& operator<<=(_enumType& _a,int n){ _a = _enumType(((U32)_a) << n); return _a; } \
	inline constexpr friend _enumType operator>>(_enumType _a,int n){ return _enumType( ((U32)_a)>>n ); } \
	inline constexpr friend _enumType& operator>>=(_enumType& _a,int n){ _a = _enumType(((U32)_a) >> n); return _a; }
