...
namespace sys
{
	...
	float AndroidInputManager::GetAction(int inputid,int actionid)
	{
		/*
	...
	void AndroidInputManager::Update(float dTime)
	{
		/*
		// Update from mouse
